...
export default function CaseSection10() {
  return (
    <section id="cases3" className="py-24 bg-black text-white scroll-mt-20">
      <div className="container mx-auto px-4 max-w-6xl">
        ...
        <div className="text-center mb-16">
          ...
          <h2 className="text-3xl md:text-5xl font-bold text-white mb-4 leading-tight">
            お客様の
            <span className="block text-[#37B7C4]">声</span>
          </h2>
          ...
          {cases.map((testimonial, idx) => (
            <div key={idx} className="group">
              <div className="bg-white p-8 border-l-4 border-[#37B7C4] relative">
                {/* 引用符装飾 */}
                <div className="absolute -top-4 -left-4 w-8 h-8 bg-[#37B7C4] flex items-center justify-center">
                  <span className="text-white font-bold text-xl">"</span>
                </div>
                
                <div className="mb-6">
                  <h3 className="font-bold text-xl text-black mb-2">{testimonial.company}</h3>
                ...
                <div className="flex items-center justify-between">
                  <div>
                    <div className="font-bold text-black">{testimonial.person}</div>
        ...
        <div className="text-center">
          <a 
            href="/lp10/reviews" 
            className="inline-block bg-white text-black border-2 border-white px-8 py-4 font-bold text-lg hover:bg-black hover:text-white transition-all duration-300"
          >
            さらに多くのお客様の声を見る
          </a>
        </div>
