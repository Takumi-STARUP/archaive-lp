  ...
  return (
    <section id="features2" className="py-20 bg-white">
      <div className="container mx-auto px-4">
        <h2 className="text-4xl font-extrabold text-center mb-12 text-purple-700 drop-shadow">なぜARCHAIVEなら、"見積もり3分"が可能なのか？</h2>
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          {features.map((f, idx) => (
            <div key={idx} className={`rounded-2xl shadow-lg p-8 bg-gradient-to-br ${f.color} text-center flex flex-col items-center`}> 
              <Icon type={f.icon as any} size={48} className="mb-4" />
