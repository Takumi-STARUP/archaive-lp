...
export default function Footer2() {
  return (
    <footer className="bg-black text-white py-16 mt-12 border-t border-white/20">
      <div className="container mx-auto px-4 flex flex-col md:flex-row justify-between items-center gap-8">
        ...
        <div className="flex flex-col items-center md:items-start gap-3">
          ...
          <div className="text-sm text-white/70">ARCHAIVE株式会社</div>
        ...
        <div className="flex gap-4">
          <a 
            ...
            className="w-10 h-10 bg-white/10 rounded-lg flex items-center justify-center hover:bg-[#37B7C4]/20 transition"
          >
      ...
      <div className="text-center text-sm text-white/50 mt-8 border-t border-white/10 pt-8">
