...
export default function ProductSection2() {
  return (
    <section className="py-20 bg-black text-[#37B7C4] shadow-2xl rounded-3xl">
      <div className="container mx-auto px-4 max-w-5xl">
        <h2 className="text-4xl font-extrabold mb-8 text-[#37B7C4] text-center drop-shadow">革命を支える、盤石なデータ活用基盤</h2>
        <p className="text-xl text-[#37B7C4] text-center mb-10 font-semibold">
          ...
          {features.map((f, idx) => (
            <div key={idx} className="flex items-start gap-4 bg-[#37B7C4]/10 rounded-2xl shadow p-8 border border-[#37B7C4]/20">
              ...
              <div>
                ...
                <div className="text-[#37B7C4]/90">{f.description}</div>
              </div>
            </div>
          ))}
        </div>
