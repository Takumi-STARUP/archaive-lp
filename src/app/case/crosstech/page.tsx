        ...
        <div className="interview-content-wrapper">
          <div className="interview-content">
            ...
            <div className="company-info">
              ...
              <p>必要とするモノを必要としているヒトへ、ツナグ技術を対話の中から常に追い求め、モノを手にした人が物心一如になるように、自分たちの周りにあるすべてのモノ、ヒトに感謝を忘れずに造るを極める。それを、次世代にツナグ。<br />
              そんな『ヒトとモノをツナグ技術』を追求する集団として、ワイヤー放電加工やコーディネイト等を行っている。</p>
              <p><strong>会社HP：</strong><a href="https://www.crosstech.osaka/" target="_blank" rel="noopener noreferrer">https://www.crosstech.osaka/</a></p>
            </div>
          </div>
        </div>
      </main>
